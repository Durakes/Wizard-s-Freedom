...
public class Spider_VolverBehaviour : StateMachineBehaviour
{
    ...
    {
        spider = animator.gameObject.GetComponent<Spider>();
        puntoInicial = spider.puntoInicial;
